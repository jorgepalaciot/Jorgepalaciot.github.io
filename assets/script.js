(function () {
  ...
  /* =========================================================
     ...
     Title/description per page come from data-es / data-en
     attributes set by the Jekyll layout (see _layouts/default.html).
  ========================================================= */
  ...
  function applyLang(lang) {
    ...
    ["page-title", "og-title"].forEach(function (id) {
    ...
    ["meta-description", "og-description"].forEach(function (id) {
      var el = document.getElementById(id);
      if (!el) return;
      var text = el.getAttribute("data-" + lang);
